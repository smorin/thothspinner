...
Features demonstrated:
- All 41 built-in spinner styles (`npm_dots`, `claude_stars`, `classic`, `dots`, `arc`, `line`, `pulse`, `moon`, `clock`, `dice`, `rune`, `matrix`, `orbit`, `heartbeat`, `weather`, `iris`, `collapse`, and more)
